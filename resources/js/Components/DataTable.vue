            ...
            <table class="relative w-full whitespace-no-wrap bg-white border-collapse table-auto table-striped">
                <thead>
                    <tr class="text-left">
                        ...
                        <th v-for="heading in headings" :key="heading.key" class="sticky top-0 px-6 py-4 text-sm font-bold tracking-wider text-white uppercase bg-pink-700 border-b border-gray-200"
                            v-text="heading.value" v-show="!heading.hidden" :ref="heading.key" :class="{ [heading.key]: true }"></th>
                        <th v-if="actions && actions.length > 0" class="sticky top-0 px-6 py-4 text-sm font-bold tracking-wider text-white uppercase bg-pink-700 border-b border-gray-200">Actions</th>
                    </tr>
                </thead>
